...
<body>
    ...
    <!-- Debut du titre-->
    <div class="tete">
        <span class="titr">Lancer votre site web en ligne</span>
        <img class="img-db" src="img/icon-html.png" alt="formulaire">
    </div>
    <div class="content">
        <span class="content-html">Le lancement d'un site web en ligne est un processus qui consiste à mettre le site web en ligne sur un serveur web, afin que les internautes puissent y accéder. Ce processus implique généralement la réservation d'un nom de domaine et l'hébergement du site web sur un serveur web.</span>
